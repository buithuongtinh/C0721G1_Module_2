...
public class TennisGameTest {
    ...
    public TennisGameTest(int player1Score, int player2Score, String expectedScore) {
        this.scorePlayer1 = player1Score;
        this.scorePlayer2 = player2Score;
    ...
    public void checkAllScores() {
        ...
        int maxScorePlayer1 = 0;
        int maxScorePlayer2 = 0;
        ...
        assertEquals(this.expectedScore, TennisGame.getScore("John", "Bill", maxScorePlayer1, maxScorePlayer2));
    }
}
